...
--
-- ДОГОНЯЮЩИЙ СКРИПТ: нужен только базам, где sw-registry-firmware.sql применяли
-- в редакции от 16.09.2026 — там этого индекса ещё не было. На новой базе
-- индекс создаёт сам sw-registry-firmware.sql, и этот файл ничего не делает.
--
