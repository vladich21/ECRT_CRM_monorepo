...
export class AuthController {
  ...
  /** Без JWT: только чистит cookie. Нужен для истекшего токена и синхронизации с клиентом после 401. */
  @Public()
  /** Без валидного JWT: только снимает cookie. Нужно при истекшем токене и синхронизации с клиентом после 401. */
  @Public()
  @Post('logout')
