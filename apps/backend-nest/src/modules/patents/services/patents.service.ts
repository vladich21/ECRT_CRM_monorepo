...
import { PatentExportService, type PatentsExportPayload } from './patent-export.service';
...
export class PatentsService {
  ...
  constructor(
    ...
    private readonly patentExportService: PatentExportService,
  ) {}
  ...
  async findAllForExport(
    ...
    return this.patentExportService.buildExportPayload(
