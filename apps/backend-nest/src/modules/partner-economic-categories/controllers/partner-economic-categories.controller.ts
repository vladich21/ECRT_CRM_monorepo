...
@Controller('partner-economic-categories')
export class PartnerEconomicCategoriesController {
  constructor(private readonly service: PartnerEconomicCategoriesService) {}
