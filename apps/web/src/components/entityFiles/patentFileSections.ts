...
export const PATENT_FILE_DECISION_SECTIONS = [
  {
    ...
    title: 'Положительное',
    hint: 'Документы положительного решения или отметка «Решение получено» без файла.',
  },
  {
    key: 'decision_negative',
    title: 'Отрицательное',
    hint: 'Документы отрицательного решения или отметка «Отказ в выдаче» без файла.',
  },
] as const;
