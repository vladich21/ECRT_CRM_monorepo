        ...
        <p style={{ marginBottom: 12 }}>
          {blockModalMode === 'manual_unblock'
            ...
            : blockModalMode === 'auto_reason'
              ...
              : 'Контрагент будет переведен в статус «Заблокирован». Укажите обязательную причину — она сохранится в поле «Причина блокировки/разблокировки» на вкладке «Основное» и во вкладке «Комментарии».'}
        </p>
