...
import { SwFilterTabs } from '../shared/SwFilterTabs';
import { SwItemsFiltersModal } from '../items/SwItemsFiltersModal';
import { SwSummaryTable } from './SwSummaryTable';
import { buildSwRegistryReturnPath } from '../shared/swRegistryNavigation';
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className={styles.infoBanner}>
            Свод формируется по активным и архивным программам и документам; удаленные не учитываются. Клик по числу
