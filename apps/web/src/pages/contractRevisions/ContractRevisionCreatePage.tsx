...
import { SaveOutlined, CloseOutlined, HistoryOutlined, PlusOutlined } from '@ant-design/icons';
      ...
      <Space direction='vertical' size='middle' style={{ width: '100%' }}>
        ...
        <Card
          title={
            <Space>
              <HistoryOutlined />
              <span>Создание новой ревизии договора</span>
              <Tag color='blue'>На основе версии: {contract.number}</Tag>
            </Space>
          }
        >
          <Form
