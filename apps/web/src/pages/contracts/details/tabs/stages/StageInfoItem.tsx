      ...
      <div className={styles.stageInfoItem}>
        ...
        <div className={styles.stageInfoValue}>
          <div className={styles.stageInfoRow}>
            <Text type="secondary" className={styles.stageInfoTextSecondary}>План: </Text>
          ...
          {(stage.actual_start_date || stage.actual_end_date) && (
            <div className={styles.stageInfoRow}>
              <Text type="secondary" className={styles.stageInfoTextSecondary}>Факт: </Text>
              <Text className={styles.stageInfoText}>
          ...
          {stage.planned_budget > 0 || stage.forecasted_budget > 0 || stage.actual_budget > 0 ? (
            <>
              ...
              {stage.forecasted_budget > 0 && (
                <div className={styles.stageInfoRow}>
                  <Text type="secondary" className={styles.stageInfoTextSecondary}>Прогноз: </Text>
                ...
                <div className={styles.stageInfoRow}>
                  ...
                  {budgetDeviation !== null && (
                    <Tag
                      ...
                      style={{
                        backgroundColor: budgetDeviation > 0 ? 'rgba(211, 47, 47, 0.1)' : budgetDeviation < 0 ? 'rgba(84, 177, 40, 0.1)' : 'rgba(217, 217, 217, 0.1)',
                        color: budgetDeviation > 0 ? '#D32F2F' : budgetDeviation < 0 ? '#54B128' : '#525252',
                        border: budgetDeviation > 0 ? '1px solid #D32F2F' : budgetDeviation < 0 ? '1px solid #54B128' : '1px solid #D9D9D9',
                      }}
                    >
  ...
  if (type === 'responsible') {
    return (
      <div className={styles.stageInfoItem}>
        ...
        <div className={styles.stageInfoValue}>
          <Text className={styles.stageInfoText}>
            {getNameById(stage.responsible_id, users) || 'Не назначен'}
          </Text>
          {isCompleted && stage.actual_end_date && (
            <div className={styles.completedInfo}>
              <Text className={styles.completedText}>
                Завершен {formatDate(stage.actual_end_date)}
              </Text>
            </div>
          )}
        </div>
