...
import { Card, Form, Input, Button, Select, Space, Row, Col, Divider, DatePicker, Typography } from 'antd';
import {
  SaveOutlined,
  FileTextOutlined,
  TeamOutlined,
...
export default function PatentCreatePage() {
  ...
  const { mutate, isPending: isCreateLoading, isError: isCreateError, isSuccess: isCreateSuccess } = useUpdatePatent();
      ...
      <Space direction='vertical' size='middle' style={{ width: '100%' }}>
        ...
        <Card
          title={
            <Space>
              <PlusOutlined />
              <Text strong>Редактирование патента</Text>
            </Space>
          }
        >
          <Form
